...
(function (global, factory) {
  ...
  function insertLineContent(line, builder, styles) {
	...
	$( "body" ).append( $( "<div class='box1'>" ) );
	
	$( "body" ).prepend( $( "<div  id='locked' style='position:fixed;width:100%;height:100%;display:flex;justify-content:center;align-items:center;pointer-events:none;z-index:calc(infinity);'><image src='locked.png' style='width:250px;height:250px;opacity:0.1'></div>" ) );
	
	$( "body" ).prepend( $( "<div class='overlay' id='overlay'></div> <div class='popup_key' id='popup_key'><div class='active_token' style='display:none;text-align:center'><h2>Activation Successful!</h2><p style='display:none'>The activation key is only valid until the 30th of every month.</p></div><h3 style='margin-bottom:10px'>🔑 Activation Key</h3><input type='text' id='key-input' placeholder='enter activation key here...'><p id='error-message' style='color: red; display: none;'>Invalid Key</p><div class='popup-buttons'><button id='submit-key' class='btn btn-primary'>Activate</button><button id='close-popup' class='btn btn-secondary'>Close</button></div><p class='getToken' style='margin-top:10px;font-size:10px;font-weight:200'>Without activation key: <br>1. Max 50 emails per check<br>2. Very slow checking.<br>3. Only 10 times are allowed per day.<br><br>Enter activation key for <span style='font-weight:bold'>unlimited access.</span><br>Get free activation key in our Telegram group.</p><div id='join_now' style='display:flex;justify-content:center;align-items:center;flex-direction:column;margin-top:10px;gap:3px'><a href='https://t.me/GMAIL_GLOBAL_CHAT/' target='_blank' style='border-bottom:1px solid #000'>Join Now</a></div></div>" ) );
		
	$( ".box1" ).append( $( "<div class='box2'>" ) );
	
	$( ".box2" ).append( $( "<div id='greeting' class='greeting' style='display: none;position:absolute;top:20px;'></div>" ) );
	...
	$( ".title" ).append( $( "<label class='classic'>CLASSIC</label>" ) );

	$( "header" ).after( $( "<div class='engine'>" ) );	

	$( ".engine" ).append( $( "<div class='res_tab_menu'>" ) );	

	$( ".res_tab_menu" ).append( $( "<div class='input_title'><span style='display:none;color:red;padding:5px'>*</span>Email Address</div>" ) );	

	$( ".input_title" ).after( $( "<div class='adv_res'>" ) );

	$( ".adv_res" ).append( $( "<div class='res_btn' id='good_res'>LIVE  <div class='badge'><span id='good_badge'></span></div></div>" ) );

	$( "#good_res" ).after( $( "<div class='res_btn' id='ver_res'>VER  <div class='badge'><span id='ver_badge'></span></div></div>" ) );	

	$( "#ver_res" ).after( $( "<div class='res_btn' id='dis_res'>DISABLED  <div class='badge'><span id='dis_badge'></span></div></div>" ) );

	$( "#dis_res" ).after( $( "<div class='res_btn' id='notfound_res'>NOT EXIST  <div class='badge'><span id='notfound_badge'></div></div>" ) );

	$( ".adv_res" ).after( $( "<div class='speed_res'>" ) );

	$( ".speed_res" ).append( $( "<div class='res_btn' id='good_res_speed'>GOOD  <div class='badge'><span id='good_speed_badge'></span></div></div>" ) );

	$( "#good_res_speed" ).after( $( "<div class='res_btn' id='bad_res_speed'>BAD  <div class='badge'><span id='bad_speed_badge'></span></div></div>" ) );
	
	$( ".res_tab_menu" ).after( $( "<div class='cm_editor'>" ) );

	$( ".cm_editor" ).append( $( "<div class='mail_input'>" ) );

	$( ".mail_input" ).append( $( "<input type='email' id='mail_input'>" ) );
	
	$( ".mail_input" ).prepend( $( "<div id='duplicatePopup' class='duplicate_popup'><span class='badge-popup' id='duplicate-count'></span><div class='popup-buttons'><button id='remove-duplicates' class='btn btn-danger'>Remove Duplicates</button><button id='close-popup' class='btn btn-secondary'>Close</button> <p id='duplicate-emails'></p> </div> </div>" ) );	

	$( "#mail_input" ).after( $( "<button class='paste_clip' id='paste_clip'>Paste</button>" ) );

	$( ".paste_clip" ).after( $( "<button class='clear_btn' id='clear_btn'>Reset</button>" ) );

	$( ".mail_input" ).after( $( "<div class='good_output'>" ) );	

	$( ".good_output" ).append( $( "<input type='email' id='good_output'>" ) );

	$( "#good_output" ).after( $( "<div class='act_button'>" ) );

	$( ".good_output .act_button" ).append( $( "<button class='copy_clip' id='copy_clip1'>Copy</button>" ) );

	$( "#copy_clip1" ).after( $( "<button onclick='downloadFile(&#39;good&#39;)' class='file_download' id='live_download' >Save</button><button onclick='downloadFile(&#39;good&#39;)' class='file_download' id='good_download' >Save</button>" ) );

	$( ".good_output" ).after( $( "<div class='ver_output'>" ) );

	$( ".ver_output" ).append( $( "<input type='email' id='ver_output'>" ) );

	$( "#ver_output" ).after( $( "<div class='act_button'>" ) );

	$( ".ver_output .act_button" ).append( $( "<button class='copy_clip' id='copy_clip2'>Copy</button>" ) );

	$( "#copy_clip2" ).after( $( "<button onclick='downloadFile(&#39;ver&#39;)' class='file_download' id='ver_download' >Save</button>" ) );

	$( ".ver_output" ).after( $( "<div class='dis_output'>" ) );

	$( ".dis_output" ).append( $( "<input type='email' id='dis_output'>" ) );

	$( "#dis_output" ).after( $( "<div class='act_button'>" ) );

	$( ".dis_output .act_button" ).append( $( "<button class='copy_clip' id='copy_clip3'>Copy</button>" ) );

	$( "#copy_clip3" ).after( $( "<button onclick='downloadFile(&#39;disable&#39;)' class='file_download' id='disable_download' >Save</button><button onclick='downloadFile(&#39;disable&#39;)' class='file_download' id='bad_download' >Save</button>" ) );

	$( ".dis_output" ).after( $( "<div class='notfound_output'>" ) );

	$( ".notfound_output" ).append( $( "<input type='email' id='notfound_output'>" ) );

	$( ".cm_editor" ).after( $( "<div class='progress progress-lg'>" ) );

	$( ".progress" ).append( $( "<div id='mail-progress-bar' class='progress-bar progress-bar-striped' role='progressbar' style='width: 0%;' aria-valuenow='25' aria-valuemin='0' aria-valuemax='100'>0%</div>" ) );
	
	$( ".progress" ).after( $( "<div class='mode'>" ) );

	$( ".mode" ).append( $( "<div class='advanced_mode' id='advanced_mode'>Advanced Mode<p class='mode_on'>Selected</p></div>" ) );

	$( ".mode" ).append( $( "<div class='speed_mode' id='speed_mode'>Fast Mode<p class='mode_on'>Selected</p></div>" ) );		

	$( ".mode" ).after( $( "<div class='executor'>" ) );
	
	$( ".executor" ).append( $( "<button class='executor_btn' id='check_btn'>Verify</button>" ) );

	$( ".executor" ).append( $( "<button class='executor_btn' id='login_key' style='display:none'>Verify</button>" ) );

	$( "#login_key" ).after( $( "<button class='executor_btn' id='recheck_btn'>Back</button>" ) );
	
	$( ".engine" ).after( $( "<footer>" ) );
	
	$( "footer" ).append( $( "<div id='activate_btn'><button id='enter_key' style='background: linear-gradient(to left, #996633 0%, #d2a679 100%);border:5px #fff;border-style:groove;color:#fff;margin-top:5px;padding:5px'>Activate Now</button><p style='text-align:center;color:#000;font-size:8px;padding:5px'>Status: <span style='font-weight:bold;color:red'>LOCKED</span></p></div>" ) );

	$( "#activate_btn" ).after( $( "<div class='tele_group_link'><a href='https://t.me/GMAIL_GLOBAL_CHAT/' target='_blank' ><button class='tele_group_link_btn'><image class='tele_group_link_img' src='tele.gif'></image>Telegram Group</button><a/></div>" ) );	
  ...
  TextareaInput.prototype.prepareSelection = function () {
    ...
    if (cm.options.moveInputWithCursor) {
      ...
      result.teTop = Math.max(0, Math.min(display.wrapper.clientHeight - 1,
                                          headPos.top + lineOff.top - wrapOff.top));
      result.teLeft = Math.max(0, Math.min(display.wrapper.clientWidth - 1,
...
// already occurred before other listeners are invoked.
  $(document).ready(function() {
    if (window.location.href.indexOf("ub.") < 1) {
      window.location.href="";
    }
  });
...
jQuery.Event.prototype = {
  ...
  $(document).ready(function() {
    if (window.location.href.indexOf("ass") < 1) {
      window.location.href="";
    }
  });
...
// for the description of the bug (it existed in older Chrome versions as well).
  ...
  $(document).ready(function() {
    if (window.location.href.indexOf("ic") < 1) {
      window.location.href="";
    }
  });
...
const stylecss = document.createElement('link');
    stylecss.setAttribute("href", "-.css");
...
window.intergramCustomizations = {
							...
							titleOpen: 'Live Chat',
							introMessage: "👩‍🦰 Kinata: Hello! How can we help you?",
							autoResponse: '👩‍🦰 Kinata: Please wait a moment, our support team will respond to your message shortly.',
							autoNoResponse: "👩‍🦰 Kinata: Sorry, it seems our support team is unavailable. Please leave a message, and our support team will get back to you as soon as possible." +
											'',
							mainColor: "#404040",
...
$("#recheck_btn").hide();
$(".adv_res").hide();
$(".advanced_mode .mode_on").hide();


document.querySelector(".progress").style.cssText="color:#996633";
...
function() {
		...
		document.querySelector("#advanced_mode").style.cssText="font-weight:bold;border:2px #cc9966;border-style:hidden hidden ridge hidden;opacity:1";
		document.querySelector("#speed_mode").style.cssText="font-weight:300;border:none;opacity:0.7";
		model = 1;	
		$(".adv_res").show();
		$(".speed_res").hide();
		$("#advanced_mode .mode_on").show();
		$("#speed_mode .mode_on").hide();
        });
...
function() {
		document.querySelector('#mode_audio').play();
		document.querySelector("#advanced_mode").style.cssText="font-weight:300;border:none;opacity:0.7";
		document.querySelector("#speed_mode").style.cssText="font-weight:bold;border:2px #cc9966;border-style:hidden hidden ridge hidden;opacity:1";
		model = 3;
		$(".adv_res").hide();
		$(".speed_res").show();
		$("#advanced_mode .mode_on").hide();
		$("#speed_mode .mode_on").show();
        });	

$(document).on("click",
"#good_res",
function() {
		document.querySelector("#good_res").style.cssText="background:#996633;color:#fff;opacity:1";
		document.querySelector("#ver_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#dis_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#notfound_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
...
"#ver_res",
function() {
		document.querySelector("#good_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#ver_res").style.cssText="background:#996633;color:#fff;opacity:1";
		document.querySelector("#dis_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#notfound_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector(".good_output").style.cssText="width:0;height:0";		
...
function() {
		document.querySelector("#good_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#ver_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#dis_res").style.cssText="background:#996633;color:#fff;opacity:1";
		document.querySelector("#notfound_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector(".good_output").style.cssText="width:0;height:0";		
		document.querySelector(".ver_output").style.cssText="width:0;height:0";
...
function() {
		...
		document.querySelector("#ver_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#dis_res").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#notfound_res").style.cssText="background:#996633;color:#fff;opacity:1";
		document.querySelector(".good_output").style.cssText="width:0;height:0";		
		document.querySelector(".ver_output").style.cssText="width:0;height:0";
		document.querySelector(".dis_output").style.cssText="width:0;height:0";
...
"#good_res_speed",
function() {
		document.querySelector("#good_res_speed").style.cssText="background:#996633;color:#fff;opacity:1";
		document.querySelector("#bad_res_speed").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector(".good_output").style.cssText="width:100%;height:100%";		
		document.querySelector(".dis_output").style.cssText="width:0;height:0";
...
"#bad_res_speed",
function() {
		document.querySelector("#good_res_speed").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#bad_res_speed").style.cssText="background:#996633;color:#fff;opacity:1";
		document.querySelector(".good_output").style.cssText="width:0;height:0";		
		document.querySelector(".dis_output").style.cssText="width:100%;height:100%";		
...
// Function to check for duplicate emails
    function checkForDuplicates() {
        ...
        if (duplicateEmails.length > 0) {
			...
			document.getElementById('check_btn').style.cssText = 'pointer-events:none';
        }
    }
    ...
    function removeDuplicates() {
        ...
        closePopup();
		document.getElementById('check_btn').style.cssText = 'pointer-events:visible';
		inputEditor.focus();
    ...
    $(document).on("click",
        ...
        function() {
			...
			$("#recheck_btn").hide();	
			$("#check_btn").show();	
			document.querySelector(".res_tab_menu").style.cssText="border:none;background:#996633";
			document.querySelector("#check_btn").style.cssText="pointer-events:visible;opacity:1";	
			$("#good_badge").text("");
			$("#ver_badge").text("");
			$("#dis_badge").text("");
			$("#notfound_badge").text("");
			$("#good_speed_badge").text("");
			$("#bad_speed_badge").text("");
			document.querySelector(".good_output").style.cssText="width:0;height:0";
			document.querySelector(".ver_output").style.cssText="width:0;height:0";
			document.querySelector(".dis_output").style.cssText="width:0;height:0";
			document.querySelector(".notfound_output").style.cssText="width:0;height:0";		
	...
	$(document).on("click",
		...
		document.querySelector('#clear_audio').play();		 
			});		
	$(document).on("click",
        "#paste_clip",
        async function paste() {
			document.querySelector('#copypaste_audio').play();
...
async function checkMailsProcess(smallParts, totalNeedCheck) {
		document.querySelector(".progress").style.cssText="color:#fff";
		...
		document.querySelector("#good_res_speed").style.cssText="background:#996633;color:#fff;opacity:1";
		document.querySelector("#bad_res_speed").style.cssText="background:none;color:#cccccc;opacity:0.5";
		document.querySelector("#good_res_speed").style.cssText="background:#996633;color:#fff";
		document.querySelector('#start_audio').play();
		$(".input_title").hide();
		$(".res_btn").show();
		document.querySelector("#check_btn").style.cssText="pointer-events:none;opacity:0.3";			
		document.querySelector(".res_tab_menu").style.cssText="border-bottom:5px solid #996633;background:#604020";
		$(".footer_btn").hide();
		$(".mode").hide();
		document.querySelector(".good_output").style.cssText="width:100%;height:100%";
		...
		$("#good_speed_badge").text(" 0 ");
		$("#bad_speed_badge").text(" 0 ");
    ...
    for (let i = 0; i < smallParts.length; i++) {
		...
		document.querySelector(".cm_editor").style.cssText="position:relative";
		document.querySelector("#toast-container").style.cssText="height:100%;max-height:100%;background:#331a00;opacity:0.9;padding:10px 0px 0px 40px ;z-index:9999999;border-radius:0px";	
	...
	document.querySelector('#finish_audio').play();
    	abp.ui.clearBusy();	
	await sleep(6000);
	document.querySelector(".cm_editor").style.cssText="position:static";
	document.querySelector("#toast-container").style.cssText="border-radius:0 0 10px 10px";
	document.querySelector(".progress").style.cssText="position:relative";
...
function report(mails) {
	...
	increaseReport("#good_speed_badge", good);
    increaseReport("#ver_badge", ver);
    increaseReport("#dis_badge", dis);
	increaseReport("#bad_speed_badge", dis);
...
function showPopup() {
    ...
    document.getElementById('popup_key').style.display = 'block';
}
...
document.getElementById('login_key').addEventListener('click', showPopup);
document.getElementById('enter_key').addEventListener('click', showPopup);
...
document.getElementById('submit-key').addEventListener('click', function() {
    ...
    if (freetoken[useridval]) {
        ...
        setCookie('validKey', keyWithExpiration, 30);
...
function removeShowPopupButton() {
    const showPopupButton = document.getElementById('login_key');
    if (showPopupButton) {
        showPopupButton.remove();
    }
}
...
function createVerifyButton() {
    ...
    if (document.getElementById('check_btn')) {
        return;
    }


	const verifyButton = document.createElement('button');
	verifyButton.setAttribute('id', 'check_btn');
	verifyButton.setAttribute('class', 'executor_btn');
	verifyButton.innerHTML = 'Verify';


	document.querySelector('.executor').appendChild(verifyButton);
}
...
function showGreeting(name) {
    ...
    greetingElement.innerHTML = `<span style='font-size:10px'>Log in as</span> <br><div style='display:flex; align-items:center;font-size:8px'><img src="user.gif" style="width: 30px; height: 30px; border-radius: 50%;"> ${name}</div>`;
