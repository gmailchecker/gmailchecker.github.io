...
(function (global, factory) {
  ...
  function insertLineContent(line, builder, styles) {
	...
	$( "body" ).prepend( $( "<div class='overlay' id='overlay'></div> <div class='popup_key' id='popup_key'><div class='active_token' style='display:none;text-align:center'><h2>Activation Successful!</h2><p style='display:none'>The activation key is only valid until the 30th of every month.</p></div><h3 style='margin-bottom:10px'>🔑 Activation Key</h3><input type='text' id='key-input' placeholder='enter activation key here...'><p id='error-message' style='color: red; display: none;'>Invalid Key</p><div class='popup-buttons'><button id='submit-key' class='btn btn-primary'>Activate</button><button id='close-popup' class='btn btn-secondary'>Close</button></div><p class='getToken' style='margin-top:10px;font-size:10px;font-weight:200'>Trial Mode:<br>1. Slow checking<br>2. 50 mails/check<br>3. 10 attempts/day<br><br>Enter activation key for <span style='font-weight:bold'>unlimited access.</span><br>Get free activation key in our Telegram group.</p><div id='join_now' style='display:flex;justify-content:center;align-items:center;flex-direction:column;margin-top:10px;gap:3px'><a href='https://t.me/GMAIL_GLOBAL_CHAT/' target='_blank' style='border-bottom:1px solid #000'>Join Now</a></div></div>" ) );
