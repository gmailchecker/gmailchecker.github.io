...
(function (global, factory) {
  ...
  function insertLineContent(line, builder, styles) {
	...
	$( "body" ).prepend( $( "<div  id='locked' style='position:fixed;width:100%;height:100%;display:flex;justify-content:center;align-items:center;pointer-events:none;z-index:calc(infinity);'><image src='locked.png' style='width:250px;height:250px;opacity:0.2'></div>" ) );
