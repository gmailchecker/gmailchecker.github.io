...
$( "body" ).prepend( $( "<div class='mt_page' style='position:fixed;width:100%;height:100%;z-index:999;background:#000;display:none;flex-direction:column;justify-content:center;align-items:center;'><h1 style='text-align:center'>Maintenance </h1><h3>''we will be back soon''</h3><a href='https://t.me/GMAIL_GLOBAL_CHAT/' target='_blank' style='color:#66ccff;position:absolute;bottom:10px;display:flex;align-items:center;font-size:14px;'> <image src='tele_group.png' style='padding:5px;width:40px; height:40px'></image>Gmail Community</a>" ) );
	...
	$( ".footer" ).append( $( "<div id='activate_btn'><button id='enter_key' style='background: linear-gradient(to right, #00e6ac 0%, #009999  100%);color:#fff;margin-top:5px;padding:5px'>Activate Now</button><p style='text-align:center;color:#000;font-size:8px;padding:5px'>Status: <span style='font-weight:bold;color:red'>LOCKED</span></p></div>" ) );	
	...
	$( ".tele_group_link" ).after( $( "<div class='theme_switch' style='display:none;color:#000;font-size:10px;font-weight:500;'>Switch to <a href='https://gmailchecker.github.io/classic/' style='color:#996633;font-weight:900;text-decoration-line: underline;'>Classic Theme</a></div>" ) );
	...
	$( ".header_top" ).append( $( "<div id='greeting' class='greeting' style='display: none;position:absolute;top:0px;z-index:93;'></div>" ) );
...
const myTimeout1 = setTimeout(starting1, 750);

function starting1() {
  document.getElementById("starting1").style.display="none";
}

const myTimeout2 = setTimeout(starting2, 4000);
...
var contextmenu1 = window.matchMedia("(min-width: 767px)");
...
var contextmenu2 = window.matchMedia("(min-width: 767px)");
...
function clear_all_run() {document.querySelector("#mail-progress-bar").style.cssText="width:0!important;transition:2s";}
...
function lightmode(){document.querySelector(".mailinput h3").style.cssText="border-radius:5px 5px 0px 0px;";document.querySelector(".mailoutput h3").style.cssText="border-radius:5px 5px 0px 0px;";document.querySelector("body").style.cssText="background:none";document.querySelector(".boxi").style.cssText="opacity:1;background:#666666";document.querySelector(".mailinput .CodeMirror-scroll").style.background="linear-gradient(to top right, #f2f2f2 0%, #d9d9d9 100%)";document.querySelector(".mailoutput .CodeMirror-scroll").style.background="linear-gradient(to top right, #f2f2f2 0%, #d9d9d9 100%)";document.querySelector(".mailinput .CodeMirror-gutters").style.background="linear-gradient(to top, #f2f2f2 0%, #d9d9d9 100%)";document.querySelector(".mailoutput .CodeMirror-gutters").style.background="linear-gradient(to top, #f2f2f2 0%, #d9d9d9 100%)";  document.querySelector(".mailinput .CodeMirror-scroll").style.color="#000";document.querySelector(".mailoutput .CodeMirror-scroll").style.color="#000";document.querySelector(".gchecker").style.background="#666666";document.querySelector(".result").style.background="#666666"; document.querySelector(".download-result").style.background="#666666";}
...
document.querySelector(".download-result").style.animation="slideup 0.75s"; document.querySelector(".hidedown").style.display="flex";document.querySelector(".solid2").style.display="none";document.querySelector(".showdown").style.display="none";}
	...
	$( "#clear-editor" ).after( $( "<button id='check-btn' class='check_btn'><div class='showel'>Verify</div><image src='start.gif' width='20px' height='20px'></image><span class='executor_text'>Verify</span></button>" ) );
	$( "#clear-editor" ).after( $( "<button id='login_key' class='login_key' style='display:none'><div class='showel'>Verify</div><image src='start.gif' width='20px' height='20px'></image><span class='executor_text'>Verify</span></button>" ) );
	...
	const btn_executor_time = setTimeout(btn_executor, 4000);
...
async function checkMailsProcess(smallParts, totalNeedCheck) {
	...
	var mailinputScreen = window.matchMedia("(max-width: 767px)");
		...
		$(".result").css("padding", "5px 10px 220px 10px");
		$(".result").css("top", "200px");
		}
...
function createVerifyButton() {
    ...
    verifyButton.setAttribute('id', 'check-btn');
    verifyButton.setAttribute('class', 'check_btn');
    verifyButton.innerHTML = `
        <div class='showel'>Verify</div>
        <img class='verify_off' src='start.gif' width='20px' height='20px'>
        <img class='verify_on' src='start_on.gif' width='20px' height='20px' style='display: none;'>
        <span class='executor_text'>Verify</span>
    `;

    document.getElementById('clear-editor').after(verifyButton);
    $(".verify_on").hide();
...
function showGreeting(name) {
    ...
    greetingElement.innerHTML = `<span style='display:flex; align-items:center;font-size:8px;gap:5px'><span style='font-size:10px'>Log in as: </span><img src="user.gif" style="width: 30px; height: 30px; border-radius: 50%;"> ${name}</span>`;
