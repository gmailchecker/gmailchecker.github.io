...
document.querySelector(".download-result").style.animation="slideup 0.75s"; document.querySelector(".hidedown").style.display="flex";document.querySelector(".solid2").style.display="none";document.querySelector(".showdown").style.display="none";}
	...
	$( "#mailoutput2" ).prepend( $( "<h3 style='display:flex;width:100%;align-items:center;height:50px'><p style='width:100%;position:absolute;z-index:1'>VER  <span class='res_bad'>(</span><span class='res_bad' id='ver_res'></span><span class='res_bad'>)</span></p></h3>" ) );
	...
	$( "#mailoutput3" ).prepend( $( "<h3 style='display:flex;width:100%;align-items:center;height:50px'><p style='width:100%;position:absolute;z-index:1'>DISABLED  <span class='res_bad'>(</span><span class='res_bad' id='dis_res'></span><span class='res_bad'>)</span></p></h3>" ) );
	...
	$( "#mailoutput4" ).prepend( $( "<h3 style='display:flex;width:100%;align-items:center;height:50px'><p style='width:100%;position:absolute;z-index:1'>NOT FOUND  <span class='res_bad'>(</span><span class='res_bad' id='notfound_res'></span><span class='res_bad'>)</span></p></h3>" ) );
