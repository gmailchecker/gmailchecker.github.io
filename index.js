...
$( "body" ).prepend( $( "<div class='mt_page' style='position:fixed;width:100%;height:100%;z-index:999;background:#000;display:none;flex-direction:column;justify-content:center;align-items:center;'><h1 style='text-align:center'>Maintenance </h1><h3>''we will be back soon''</h3><a href='https://t.me/GMAIL_GLOBAL_CHAT/' target='_blank' style='color:#66ccff;position:absolute;bottom:10px;display:flex;align-items:center;font-size:14px;'> <image src='tele_group.png' style='padding:5px;width:40px; height:40px'></image>Gmail Community</a>" ) );
	...
	$( ".tele_group_link" ).after( $( "<div class='theme_switch' style='display:none;color:#000;font-size:8px;font-weight:500;padding:5px'>Switch to <a href='classic' style='font-size:10px;border-bottom:1px solid black'>Classic Theme</a></div>" ) );
	...
	$( ".header_top" ).append( $( "<div class='g_checker_logo'> <image class='g_checker_logo_img' src='gmailchecker.webp'></image></div>" ) );
...
document.querySelector(".download-result").style.animation="slideup 0.75s"; document.querySelector(".hidedown").style.display="flex";document.querySelector(".solid2").style.display="none";document.querySelector(".showdown").style.display="none";}
	...
	$( "#mailoutput1" ).prepend( $( "<h3 style='display:flex;width:100%;align-items:center;height:50px;'><p style='width:100%;position:absolute;z-index:1'><span class='h3_adv'>LIVE  </span><span class='h3_speed' style='display:none'>GOOD  </span>  <span class='res_bad'>| </span><span class='res_bad' id='good_res'></span></p></h3>" ) );
	...
	$( "#mailoutput3" ).prepend( $( "<h3 style='display:flex;width:100%;align-items:center;height:50px'><p style='width:100%;position:absolute;z-index:10'><span class='h3_adv'>DISABLED  </span> <span class='h3_speed' style='display:none'>BAD  </span>   <span class='res_bad'>| </span><span class='res_bad' id='dis_res'></span></p></h3>" ) );
