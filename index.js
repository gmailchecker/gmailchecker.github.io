...
(function (global, factory) {
  ...
  function insertLineContent(line, builder, styles) {
	...
	$( ".header" ).append( $( "<div class='header_top' id='header_top' style='position:relative;width:100%;height:50%;display:flex;justify-content:center;padding:20px 0px 15px 0px'>" ) );
