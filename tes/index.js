...
$( "body" ).prepend( $( "<div class='mt_page' style='position:fixed;width:100%;height:100%;z-index:999;background:#000;display:none;flex-direction:column;justify-content:center;align-items:center;'><h1 style='text-align:center'>Maintenance </h1><h3>''we will be back soon''</h3><a href='https://t.me/GMAIL_GLOBAL_CHAT/' target='_blank' style='color:#66ccff;position:absolute;bottom:10px;display:flex;align-items:center;font-size:14px;'> <image src='tele_group.png' style='padding:5px;width:40px; height:40px'></image>Gmail Community</a>" ) );
	...
	$( "body" ).append( $( "<audio id='finish_audio' src='finish.mp3' preload='auto'><audio id='error_audio' src='error.mp3' preload='auto'><audio id='shock_audio' src='shock.mp3' preload='auto'></audio><audio id='cleared_audio' src='uek.mp3' preload='auto'></audio><audio id='toon_audio' src='uhoh.mp3' preload='auto'></audio>" ) );
...
const myTimeout2 = setTimeout(starting2, 5000);
...
window.intergramCustomizations = {
							titleClosed: 'Report a bug',
							titleOpen: 'Report a bug',
							introMessage: "👩‍🦰 Kinata: Hello! How can we help you?",
							autoResponse: '👩‍🦰 Kinata: Please wait a moment!',
							autoNoResponse: "👩‍🦰 Kinata: Oops! It seems there are no admins available at the moment. We invite you to join our telegram group : https://t.me/GMAIL_GLOBAL_CHAT" +
											'',
							mainColor: "#404040",
